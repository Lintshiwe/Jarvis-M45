...
# ── JARVIS M45 — macOS Build Script ───────────────────────────
# Creates a standalone .app bundle at dist/JARVIS-M45.app
#
# Prerequisites:
...
#
# Output:
#   dist/JARVIS-M45.app   (macOS app bundle)
#   dist/JARVIS-M45       (standalone binary)

ROOT="$(cd "$(dirname "$0")/.." && pwd)"
cd "$ROOT"

echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  J.A.R.V.I.S  M45  —  macOS Build                   ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
...
if [ -d "$APP" ]; then
    ...
    echo "║                                                             ║"
    echo "║  Run:  open dist/JARVIS-M45.app                    ║"
    echo "║                                                             ║"
    echo "║  Distribution: zip the .app and distribute.                ║"
    echo "║  First launch prompts for Gemini API key.                  ║"
    echo "╚══════════════════════════════════════════════════════════════╝"
else
